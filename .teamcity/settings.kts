...
project {
    ...
    vcsRoot(HttpsGithubComKafka0238exampleTeamcityGit)
...
object HttpsGithubComKafka0238exampleTeamcityGit : GitVcsRoot({
    name = "https://github.com/kafka0238/example-teamcity.git"
    url = "https://github.com/kafka0238/example-teamcity.git"
    branch = "refs/heads/master"
    authMethod = password {
        userName = "git"
        password = ""
